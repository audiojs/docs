...
app({
  ...
  actions: {
    visit: function (model, project) {
      return { active: project && model.list.find(function (x) {
          return x.name === project;
        }) };
    },

    filter: function (model, filter) {
      return { list: projects.filter(function (x) {
          return x.name.indexOf(filter) !== -1;
        }) };
    }
  },

  view: function (model, actions) {
    return h('div', { 'class': 'app' }, sidebar(model, actions), model.active ? readme(model, actions) : start(model, actions));
  }
});

;(require('sheetify/insert')("html, body, #main, .app {\n    margin: 0;\n    padding: 0;\n    font-family: 'Source Sans Pro';\n    background: #fafafa;\n    width: 100%;\n    height: 100%;\n  }\n\n  * {\n    box-sizing: border-box\n  }\n\n  .app {\n    display: flex;\n  }") || true) && "_e3da2965";
},{"./readme":5,"./sidebar":6,"./start":7,"hyperapp":8,"projects":"projects","sheetify/insert":3}],5:[function(require,module,exports){
var _require = require('hyperapp'),
    h = _require.h;
...
},{"hyperapp":8,"marked":2,"sheetify/insert":3}],6:[function(require,module,exports){
var _require = require('hyperapp'),
    h = _require.h;

var css = 0;

module.exports = function (model, actions) {
  return h('div', { 'class': 'sidebar' }, h('h1', null, 'audio', h('span', null, '.js')), h('input', { 'class': 'list-search', placeholder: 'search packages',
    oninput: function (e) {
      return actions.filter(e.target.value);
    } }), h('div', { 'class': 'list' }, list(model, actions)));
};

var list = function (_ref, actions) {
  var active = _ref.active,
      list = _ref.list;
  return list.map(function (_ref2) {
    var name = _ref2.name;
    return h('div', { 'class': active && active.name === name ? 'active project' : 'project' }, h('a', { 'class': 'project-name', href: '#' + name }, name.indexOf('audiojs/') === 0 ? name.slice(8) : project.name));
  });
};

;(require('sheetify/insert')(".sidebar {\n    min-width: 325px;\n    padding: 20px;\n    overflow: auto;\n  }\n\n  .sidebar h1 {\n    margin: 0;\n    margin-bottom: 20px;\n    font-weight: 300;\n    font-size: 2.5em;\n  }\n\n  .sidebar h1 span {\n    color: #AAA;\n  }\n\n  .list-search {\n    font-family: 'Source Code Pro';\n    width: 100%;\n    border: 0;\n    border-bottom: 1px solid #DDD;\n    padding: 5px 0;\n    margin-bottom: 20px;\n    background: transparent;\n    outline: none;\n  }\n\n  .list .project {\n    font-family: 'Source Code Pro';\n    margin-bottom: 10px;\n  }\n\n  .list .project .project-name {\n    text-decoration: none;\n    font-size: 0.9em;\n    color: #000;\n  }\n\n  .list .project.active .project-name {\n    color: #b63030;\n  }") || true) && "_05b9529f";
},{"hyperapp":8,"sheetify/insert":3}],7:[function(require,module,exports){
var _require = require('hyperapp'),
    h = _require.h;

module.exports = function () {
  return h('div', { 'class': 'readme start' }, h('h1', null, 'audio.js documentation'));
};
},{"hyperapp":8}],8:[function(require,module,exports){
